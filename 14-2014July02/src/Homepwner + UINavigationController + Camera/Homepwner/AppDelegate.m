...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    MWItemsTableViewController *itemsTableViewController = [[MWItemsTableViewController alloc] init];
//    self.window.rootViewController = itemsTableViewController;
//    MWItemStore *leStore = [[MWItemStore alloc] init]; //[MWItemStore sharedStore];
