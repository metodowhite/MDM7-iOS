...
//                          withRowAnimation:UITableViewRowAnimationTop];
    ...
    MPADetailViewController *detailViewController = [[MPADetailViewController alloc] initForNewItem:YES];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    MPADetailViewController *detailViewController = [[MPADetailViewController alloc] initForNewItem:NO];
